...
const masterKey = 'xxxx-xxxx-xxxx-xxxx-xxxx-xxxx-xxxx-xxxx';
const privateToken = 'xxxx-xxxx-xxxx-xxxx-xxxx-xxxx-xxxx-xxxx';
const paydunyaToken = 'xxxx-xxxx-xxxx-xxxx-xxxx-xxxx-xxxx-xxxx';
...
app.get('/create_invoice', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://app.paydunya.com/api/v1/checkout-invoice/create', {
      "invoice": { "total_amount": 1000, "description": "a residence booking payment" }, "store": { "name": "resid plus test" }
    }, {
      headers: {
